...
class HotelManager:
    ...
    def search_hotels_for_guests(self, city: str, stars: int, num_guests: int) -> list[model.hotel]:
        return self.__hotel_da.search_hotels_for_guests(city, stars, num_guests)
